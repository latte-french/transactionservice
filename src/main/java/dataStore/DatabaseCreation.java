...
public class DatabaseCreation {
    ...
    public static void createUserTable() {
        try {
            String statementMessage = "CREATE TABLE IF NOT EXISTS " +
                    "users (id BIGINT NOT NULL, first_name VARCHAR(50) NOT NULL, last_name VARCHAR(50) NOT NULL,"+
                    " PRIMARY KEY (id))";
            StatementModel statementModel = new StatementModel(statementMessage);
    ...
    public static void createAccountTable() {
        try {
            String statementMessage = "CREATE TABLE IF NOT EXISTS accounts" +
    ...
    public static void createUserAccountTable() {
        try {
            String statementMessage ="CREATE TABLE IF NOT EXISTS user_accounts" +
    ...
    public static void createTransferTable(){
        try {
            String statementMessage = "CREATE TABLE IF NOT EXISTS transfers" +
                    " (id BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1, INCREMENT BY 1) PRIMARY KEY," +
